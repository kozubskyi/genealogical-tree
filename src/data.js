const data = [
	...
	},
	{
		...
		name: 'Олександр',
		patronymic: 'Олександрович',
		photo: require('./photos/Корінь Олександр Олександрович 3.jpg'),
		gender: 'male',
		status: 'relative',
	...
	},
	{
		...
		dateOfDeath: null,
		placeOfDeath: null,
		nativeCity: 'м. Бориспіль',
		cityOfResidence: 'м. Бориспіль',
		address: 'м. Бориспіль, вул. Соборна, 10, кв. 13',
		nationality: 'Україна',
		phone: '+380991050088',
		...
		kinship: '',
		biography: `
Народився 26 липня 1993 року у м. Київ де і жив за батьками перші 2 роки, а в 1995 році разом з сім'єю переїхали у Бориспіль. З ранніх років почав цікавитися футболом. Перші 9 класів вчився у ЗОШ № 8 м. Бориспіль, а 10-11 класи у Щасливському НВК. У 2010-му році зайняв 3-є (бронзове) місце у чемпіонаті України з футболу U-17 з командою РВУФК, поступившись першим двом місцям лише вихованцям Динамо та Шахтаря відповідно.

У тому ж році поступив у Київський національний торговельно-економічний університет (КНТЕУ), який завершив у 2015-му, отримавши ступінь магістра спеціальності Економіка підприємництва.

В 2011-2012 роках почав цікавитися покером. На протязі 2013-го року приймав участь у студентських покерних турнірах серії Student Poker Tour де за результатами був визнаний найкращим студентом-покеристом року.

В 2014-му разом зі збірною командою університета з футболу СК "Меркурій-КНТЕУ" виграв чемпіонат України серед вищих навчальних закладів за що отримав звання Кандидата в майстри спорту України з футболу. А в 2016-му разом з командою ФК "Бориспіль" виграв першу ліги Київської області з футболу.

Загалом цікавиться футболом, покером, подорожами, грою мафія, шахами, Counter-Strike, пейнтболом, тенісом, більярдом.

За своє життя побував в таких країнах як США, Іспанія, Італія, Німеччина, Чехія, Польща, Мальта, Турція, Єгипет, Тайланд, білорусь, росія.
`,
		position: {
			generation: 5,
			place: 40,
